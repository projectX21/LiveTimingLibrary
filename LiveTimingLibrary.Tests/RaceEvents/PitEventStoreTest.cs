public class PitEventStoreTest
{
    ...
    {
        return new PitEvent(RaceEventType.PitIn, "107", 10, TimeSpan.Parse("00:01:40.1090000"));
    }

    public static PitEvent GetFirstPitOutEvent()
    {
        return new PitEvent(RaceEventType.PitOut, "107", 11, TimeSpan.Parse("00:02:17.6010000"));
    }

    public static PitEvent GetSecondPitInEvent()
    {
        return new PitEvent(RaceEventType.PitIn, "107", 27, TimeSpan.Parse("00:47:19.1570000"));
    }

    public static PitEvent GetSecondPitOutEvent()
    {
        return new PitEvent(RaceEventType.PitOut, "107", 28, TimeSpan.Parse("00:49:01.8580000"));
    }
}