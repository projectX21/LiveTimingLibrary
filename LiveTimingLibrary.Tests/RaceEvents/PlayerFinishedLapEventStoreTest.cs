public class PlayerFinishedLapEventStoreTest
{
    ...
    {
        return new PlayerFinishedLapEvent(1, TimeSpan.Parse("00:01:45.2910000"), TimeSpan.Parse("00:01:45.2910000"));
    }

    public static PlayerFinishedLapEvent GetSecondLap()
    {
        return new PlayerFinishedLapEvent(2, TimeSpan.Parse("00:01:41.6680000"), TimeSpan.Parse("00:03:26.9590000"));
    }

    public static PlayerFinishedLapEvent GetThirdLap()
    {
        return new PlayerFinishedLapEvent(3, TimeSpan.Parse("00:01:41.1140000"), TimeSpan.Parse("00:05:08.0730000"));
    }
}