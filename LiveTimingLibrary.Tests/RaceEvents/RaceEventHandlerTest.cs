...
public class RaceEventHandlerTest
{
    ...
    public void TestAddPitEvent()
    {
        ...
        handler.AddEvent(new PitEvent(RaceEventType.PitIn, "107", 41));
        var expectedFinalEvent = new PitEvent(RaceEventType.PitIn, "107", 41, TimeSpan.Parse("01:39:10.4910000"));
    ...
    public void TestAddPlayerFinishedLapEvent()
    {
        ...
        var handler = new RaceEventHandler(mockRecoveryFile.Object, mockPitEventStore.Object, mockPlayerFinishedLapEventStore.Object);
        handler.AddEvent(new PlayerFinishedLapEvent(41, TimeSpan.Parse("00:01:35.3810000")));
        var expectedFinalEvent = new PlayerFinishedLapEvent(41, TimeSpan.Parse("00:01:35.3810000"), TimeSpan.Parse("01:40:45.8720000"));
        mockRecoveryFile.Verify(m => m.AddEvent(expectedFinalEvent), Times.Once());
    ...
    public void TestSessionReloadEvent()
    {
        ...
        mockRecoveryFile.Setup(m => m.ReadPitEvents()).Returns(
            [PitEventStoreTest.GetFirstPitInEvent(), PitEventStoreTest.GetFirstPitOutEvent()]
        );

        mockRecoveryFile.Setup(m => m.ReadPlayerFinishedLapEvents()).Returns(
        ...
        var handler = new RaceEventHandler(mockRecoveryFile.Object, mockPitEventStore.Object, mockPlayerFinishedLapEventStore.Object);
        handler.AddEvent(new SessionReloadEvent(41));
        var expectedFinalEvent = new SessionReloadEvent(41, TimeSpan.Parse("01:39:10.4910000"));
        mockRecoveryFile.Verify(m => m.AddEvent(expectedFinalEvent), Times.Once());

        mockPitEventStore.Verify(m => m.Reset(), Times.Once());
        mockRecoveryFile.Verify(m => m.ReadPitEvents(), Times.Once());
        ...
        mockRecoveryFile.Verify(m => m.ReadPlayerFinishedLapEvents(), Times.Once());
